...
import angularGant from "angular-gantt";

// TODO

angular.module('app', ['gantt', 'gantt.table', 'gantt.x'])
    .controller('GanttController', ['$scope', '$http', function ($scope, $http) {
        $scope.dataFromServer = [{name: 'Milestones', height: '3em', sortable: false, classes: 'gantt-row-milestone', color: '#45607D', tasks: [
